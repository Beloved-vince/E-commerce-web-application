...
category_models = [Category, HealthBeautyProduct, IndoorProduct, SupermarketProduct, AppliancesProduct, ElectronicsProduct, PhoneProduct, ComputingProduct, FashionProduct, BabyProduct, SportProduct, GameProduct]
